...
def snr_mixer(clean, noise, snr, target_level=-25, target_level_lower=-35, target_level_upper=-15, clip_protect=True, clipping_threshold=0.99):
    ...
    if clip_protect and is_clipped(noisyspeech):
...
# Add, return (noisy, speech, noise)


def mix_speech_noise(data_speech, data_noise, snr, level_lower, level_upper):
